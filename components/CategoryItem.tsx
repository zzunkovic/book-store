  ...
  return (
    <Link className=" overflow-hidden" href={`/${name}`}>
      <div className="relative h-full z-20 border-b-2 border-gray-900 rounded-xl overflow-hidden">
        ...
        <div className="drop-shadow-xl  w-full  text-white text-center text-2xl   font-semibold py-4 absolute bottom-0  left-1/2 -translate-x-1/2 whitespace-nowrap z-20">
          {name}
        </div>
